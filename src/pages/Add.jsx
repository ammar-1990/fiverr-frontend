...
<input className='input' type='text' id='title' placeholder='e.g. I will do some thing I am really good at' />
...
<textarea placeholder='Brief description to introduce your sevices to customers' rows={16} cols={30}  className='resize-none input' ></textarea>
<button className='py-3 text-white font-semibold bg-green-400 rounded-md'>Create</button>
          ...
          <input className='input' type='text' placeholder='e.g. one-page web design' />
          <label className='text-gray-500' >Short Description</label>
          <textarea placeholder='Short description of your service' className='resize-none input' ></textarea>
          ...
          <input className='input' type='text' placeholder='e.g. page design' />
          <input className='input' type='text' placeholder='e.g. one-file uploading' />
          <input className='input' type='text' placeholder='e.g. setting up a domain' />
          <input className='input' type='text' placeholder='e.g. hosting' />
